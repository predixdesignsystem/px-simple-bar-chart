...
function runBaseTests() {
  px_simple_bar_chart = document.getElementById('fixture1');

  suite('Base Automation Tests for px-simple-bar-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-simple-bar-chart fixture is created', function() {
